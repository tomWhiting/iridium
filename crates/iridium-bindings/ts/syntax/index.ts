...
export class SyntaxHighlighter {
  ...
  /** Last parsed content length - used to detect large changes (paste) */
  ...
  highlightIncremental(content: string, edit: EditInfo): HighlightSpan[] {
    ...
    try {
      ...
      const newCaptures = data.query.captures(
        this.tree.rootNode,
  ...
  highlightRange(content: string, startLine: number, endLine: number, editInfo?: EditInfo | null): HighlightSpan[] {
    ...
    try {
      ...
      const captures = data.query.captures(this.tree.rootNode, startPoint, endPoint);
