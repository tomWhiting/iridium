...
//!
//! It is the mode-free host command that *opens* the panel, so the panel is not
//! on screen when it runs and cannot be what answers it. [`Verb::Dismiss`] is
...
impl Verb {
    ...
    /// command this panel has never heard of.
